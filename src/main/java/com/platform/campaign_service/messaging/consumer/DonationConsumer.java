package com.platform.campaign_service.messaging.consumer;
...
public class DonationConsumer {
    /** Service for updating campaign information based on donations. */
    ...
    public void handleDonationMessage(@Payload DonationMessageDto donationMessageDto,
        ...
        try {
            try {
                ...
                updateCampaignService.updateCurrentAmount(donationMessageDto);
